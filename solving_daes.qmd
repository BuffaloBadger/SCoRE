...
* ![](graphics/icon_video.png) [Solving DAEs (YouTube)]()
* ![](graphics/icon_video.png) [Using Python to Solve DAEs (YouTube)]()
    * ![](graphics/icon_code.png) [using_Python_to_solve_DAEs.py](comp_meth_code/using_Python_to_solve_DAEs.py)
* ![](graphics/icon_video.png) [Using Matlab to Solve DAEs (YouTube)]()
